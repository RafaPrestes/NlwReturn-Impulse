...
interface FeedbackContentStepProps {
    ...
    onFeedbackRestartRequested: () => void; //O componente recebe essa função, sem parametros e sem retorno
    onFeedbackSent: () => void;
}

export function FeedbackTypeContentStep({feedbackType, onFeedbackRestartRequested, onFeedbackSent}: FeedbackContentStepProps){ //acessando as funções
    ...
    return (
        ...
        <header>
            <button type="button" 
                    ...
                    onClick={onFeedbackRestartRequested} //quando clicar na arrow ele volta pra tela anterior (componente index.tsx)
            >
